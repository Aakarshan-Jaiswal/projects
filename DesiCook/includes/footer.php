<div class="py-5" >
    <div class="container">
        <div class="row">
            <div class="col-md-9">
                ...
                <form class="form-inline">
                    <div class="form-group"> <input type="email" class="form-control" placeholder="Your e-mail here"> </div> 
        ...
        <script src="framework/jquery.js" style=""></script>
        <script src="framework/js/bootstrap.min.js" style=""></script>
    </BODY>
</HTML>